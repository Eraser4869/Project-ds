        ...
        <tbody>
            ...
            if ($result->num_rows > 0) {
                ...
                while($row = $result->fetch_assoc()) {
                    echo "<tr>";
                    echo "<td>" . htmlspecialchars($row["직급"]) . "</td>";
                    echo "<td>" . htmlspecialchars($row["성명"]) . "</td>";
                    echo "<td>" . htmlspecialchars($row["차량종류"]) . "</td>";
                    echo "<td>" . htmlspecialchars($row["앞번호"]) . "</td>";
                    echo "<td>" . htmlspecialchars($row["차량번호"]) . "</td>";
                    echo "<td>" . htmlspecialchars($row["전화번호"]) . "</td>";
                    echo "<td>" . htmlspecialchars($row["비고"]) . "</td>";
        ...
        <form method="post" action="Controller/checkR.php" accept-charset="UTF-8">
            <div class="contsurvey">
                ...
                <div class="continput">
                    ...
                    <p class="pessential pername">이름을 적어주세요</p>
                </div>
                <div class="continput">
